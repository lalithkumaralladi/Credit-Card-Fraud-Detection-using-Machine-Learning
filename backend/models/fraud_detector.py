...
class FraudDetector:
    ...
    def train(
        ...
        **model_params
        ...
        # Optimized parameters for speed and large datasets
        n_samples = len(X_train)
        params = {
            'n_estimators': 50 if n_samples > 50000 else 100,  # Fewer trees for large datasets
            'max_depth': 8 if n_samples > 50000 else 10,
            'min_samples_split': 10 if n_samples > 50000 else 5,
            'min_samples_leaf': 4 if n_samples > 50000 else 2,
